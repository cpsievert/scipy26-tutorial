...
## chatlas: LLM based chat made easy {.center}
...
## There are many Python llm frameworks -- why chatlas?
...
::: fragment
* Simpler to get started than "mega-frameworks" (e.g., LangChain, LlamaIndex, etc.)
:::
...
1. Open up `exercises/00-hello-chat.py`.
