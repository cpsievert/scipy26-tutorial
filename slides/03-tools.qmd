...
1. Write a python function that reports the current date.
2. Register it as a tool and call it from chat.
...
5. Register it with a chatlas client and make a query to it.
