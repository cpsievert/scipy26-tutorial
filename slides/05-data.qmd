...
::: fragment
2. **Image/PDF input:** Extract data from images or PDFs, such as tables or forms
:::
...
::: fragment
4. **Entity recognition:** Identify and extract entities such as names, dates, and locations
:::

::: fragment
5. **Sentiment analysis:** Extract sentiment scores and associated entities from reviews, etc.
:::
